...
ActiveRecord::Schema[7.0].define(version: 2022_07_12_092223) do
  ...
  create_table "posts", comment: "Статьи", force: :cascade do |t|
    t.string "title", comment: "Заголовок статьи"
    t.text "content", comment: "Содержимое статьи"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.bigint "user_id", null: false, comment: "связь пользователей с постами"
    t.index ["user_id"], name: "index_posts_on_user_id"
  end

  create_table "users", comment: "Пользователь(Автор)", force: :cascade do |t|
